class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :email, :password, :type_access, :ccli,:csuplier,:cprod,:cuser,:min,:mout,:fpag,:frec,:rcli,:rsuplier,:rprod,:rpag,:rrec,:rsale,:mlog,:macerto,:rfecha)
    end
